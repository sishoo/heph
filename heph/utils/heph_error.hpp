...
#define INFO_STRING " File: " << __FILE__ << " Line: " << __LINE__
  ...
  /* ALWAYS WRAP THIS IN CURLY BRACES, IT EXPLANDS TO 2 LINES */
#define HEPH_THROW_FATAL_ERROR(err_msg) std::cerr << "Hephaestus Fatal Error: " << err_msg << " @ " << INFO_STRING << std::endl; abort();
