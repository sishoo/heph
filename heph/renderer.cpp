...
void heph_renderer_swapchain_aquire_images(HephRenderer *const r)
{
...
static void reset_image_layout(VkCommandBuffer buffer, VkImage image)
{
        VkImageMemoryBarrier2 image_barrier = {};
        image_barrier.sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2;
...
void heph_renderer_destroy(HephRenderer *const r)
{
	...
	/* Do not change ordering */
        r->swapchain_images = 0; // idk why. but why not?
