...
*/
void heph_renderer_preprocess_vertex_shader(char *const src)
{
...
void heph_renderer_preprocess_fragment_shader(char *const src)
{

}

uint32_t *heph_renderer_compile_vertex_shader(char *const src)
{

}

uint32_t *heph_renderer_compile_fragment_shader(char *const src)
{
...
void heph_renderer_init_shader_modules(HephRenderer *const r)
{
        ...
        */
        ...
        char *vertex_shader_src_string = heph_file_map_file("shader/vertex.vert");
        heph_renderer_preprocess_vertex_shader(vertex_shader_src_string);

        char *fragment_shader_src_string = heph_file_map_file("shader/fragment.frag");
...
void heph_renderer_destroy(HephRenderer *const r)
{
        ...
        for (uint32_t i = 0; i < r->additional_shader_modules; i++)
        {
                ;
        }
